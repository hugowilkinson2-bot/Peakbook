...
export default function MapPage() {
  return <AppShell><ScreenHeader eyebrow="Explora el terreno" title="Mapa" description="Tus rutas y cimas, situadas en el paisaje."/>
